 ...
 * @param {Array<{key:string,label:string,className?:string,render:(row)=>string}>} options.columns
 * @param {boolean} [options.canViewCost=false] Show cost coefficient input
 * @param {boolean} [options.isEn=false] English UI text
 * @returns {boolean} Whether the print window opened successfully
 */
