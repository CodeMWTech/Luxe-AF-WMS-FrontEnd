...
const ALIASES = {
  ...
  已结算: ['供应商已结算记录'],
  HR员工档案: ['员工档案', '员工档案附件', '员工档案其他文件批次'],
  用户管理: ['用户管理', '个人信息', '用户头像', '用户与员工档案'],
  岗位管理: ['岗位管理'],
  部门管理: ['部门管理'],
  菜单管理: ['菜单管理'],
  通知公告: ['通知公告'],
...
const COMPONENT_ALIASES = {
  ...
  'system/post/index': ALIASES['岗位管理'],
  'system/dept/index': ALIASES['部门管理'],
  'system/menu/index': ALIASES['菜单管理'],
  'system/notice/index': ALIASES['通知公告'],
...
const TITLE_OPER_TYPES = {
  ...
  个人信息: [OPER.UPDATE],
  用户头像: [OPER.UPDATE],
  用户与员工档案: [OPER.INSERT, OPER.UPDATE],
  角色管理: [OPER.INSERT, OPER.UPDATE, OPER.DELETE, OPER.GRANT, OPER.EXPORT],
  岗位管理: [OPER.INSERT, OPER.UPDATE, OPER.DELETE, OPER.EXPORT],
  部门管理: [OPER.INSERT, OPER.UPDATE, OPER.DELETE],
  菜单管理: [OPER.INSERT, OPER.UPDATE, OPER.DELETE],
  通知公告: [OPER.INSERT, OPER.UPDATE, OPER.DELETE],
  字典类型: [OPER.INSERT, OPER.UPDATE, OPER.DELETE, OPER.EXPORT, OPER.CLEAN],
  字典数据: [OPER.INSERT, OPER.UPDATE, OPER.EXPORT],
  参数管理: [OPER.INSERT, OPER.UPDATE, OPER.DELETE, OPER.EXPORT, OPER.CLEAN],
  OSS对象存储: [OPER.INSERT, OPER.DELETE],
  对象存储配置: [OPER.INSERT, OPER.UPDATE, OPER.DELETE],
  ...
  员工档案其他文件批次: [OPER.INSERT, OPER.UPDATE, OPER.DELETE]
}
